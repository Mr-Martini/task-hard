...
void main() {
  ...
  test(
    ...
    () {
      when(repository.getReminder(any, WriteOn.home)).thenReturn(Right(model));

      final result = useCase(GetNoteReminderParams(noteKey: 'noteKey', box: WriteOn.home));

      verify(repository.getReminder('noteKey', WriteOn.home));
