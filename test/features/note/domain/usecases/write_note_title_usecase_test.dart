...
void main() {
  ...
  test(
    ...
    () {
      when(repository.writeNoteTitle(any, any, any)).thenReturn(Right(model));

      final result = useCase(WriteTitleParams(title: 'dd', key: 'key', box: WriteOn.home));

      verify(repository.writeNoteTitle('dd', 'key', WriteOn.home));
