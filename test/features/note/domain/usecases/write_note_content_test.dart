...
void main() {
  ...
  test(
    ...
    () {
      when(repository.writeNoteContent(any, any)).thenReturn(Right(model));

      final result = useCase(WriteContentParams(content: 'dd', key: 'key'));

      verify(repository.writeNoteContent('dd', 'key'));
