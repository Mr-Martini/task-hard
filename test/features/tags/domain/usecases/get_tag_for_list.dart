...
void main() {
  ...
  test(
    ...
    () {
      when(repository.getTagsForList(any, WriteOn.home)).thenReturn(Right(model));

      final result = useCase(GetTagForListParams(notes: <Note>[], box: WriteOn.home));

      verify(repository.getTagsForList(<Note>[], WriteOn.home));
